...
signal-dev-doc-deck is a Rust project for developer tools. It focuses on this technical goal: Build a Rust toolkit that studies doc behavior through capacity fixtures, with allocation and spill reports and no network dependency.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 165, risk penalty 6, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
