"""Regression checks for the signal-dev-doc-deck casebook."""
...
from casebook.harness import assert_expected, signal_dev_doc_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_dev_doc_deck_summary(), assert_expected())
